        ...
        <div class = "col-md-2 overflow-auto  sticky-top  pt-5" id = "nos" data-spy="scroll" style = "height: 100vh; ">
                            ...
                            ?>
                                ...
                                <div class = " rounded bkCol">  
                                    <div class="d-flex flex-row bd-highlight mb-3">
                                            ...
                                            <a href="oneNews.php?news=  <?php echo $row['news_id']; ?>" style = "font-family: Helvetica, Arial, sans-serif;"> <h6 ><?php echo htmlspecialchars(nl2br($row['news_title'])); ?></h6></a>
            ...
            <?php
                ...
                <div class = "rounded mt-2" id = "grad" style = " border-width:1px !important;">
                        ...
                        <div clas= "">
                                ...
                                <div>
                                    <a href="oneNews.php?news=  <?php echo $row['news_id']; ?>" style = "font-family: Helvetica, Arial, sans-serif;"> <h4><?php echo htmlspecialchars(nl2br($row['news_title'])); ?></h4></a>
                                </div>
            ...
            <div class = "col-md-3 overflow-auto  sticky-top  pt-5" id = "nos" data-spy="scroll" style = "height: 100vh; ">
                ...
                <div class = "border rounded bg-warning" style = "margin-left: -4.8%; margin-right: -4%; background-color: white; ">
                    <div style = "padding-left: 15px; padding-right: 15px; background-color: white">
                            <div > 
                                   <a href="oneNews.php?news= <?php echo $row['news_id']; ?>">  <center><h6><?php echo nl2br($row['news_title']); ?></h6></center> </a>
